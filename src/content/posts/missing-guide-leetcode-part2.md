...
In [Part I](/posts/missing-guide-leetcode), I wrote about how Leetcode trains you to search your memory instead of reason from the problem. That post was about solving problems *correctly*: understand the contract, propose hypotheses, find the invariant.
